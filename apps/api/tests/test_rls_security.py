...
def test_student_upload_permission_invariant():
    ...
    assert student_role not in allowed_upload_roles, "Security Violation: Student can upload directly"
    assert lecturer_role not in allowed_upload_roles, "Security Violation: Lecturer can upload directly without review"
